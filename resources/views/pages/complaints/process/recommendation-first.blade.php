        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" data-key="SecondRecommendation" data="req"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    <button 
                        class="btn btn-outline-primary btn-flat btn-submit-recommendation-second" 
                        data-ref-no="{{ $complaint['complaint_ref_no'] }}" 
                        data-status="recommendation-second"
                    >
